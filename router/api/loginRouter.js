 ...
 * @property {string} password.required - password - eg: password
 */
 ...
 */
 ...
 router.post('/newToken', [check('token').notEmpty().isLength({ min: 5, max: 300 })], loginController.getNewToken);
 ...
 */
 ...
 router.put('/revokeToken', [check('token').notEmpty().isLength({ min: 5, max: 300 })], loginController.revokeToken);
